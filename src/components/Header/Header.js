...
const Header = () => {
 ...
 return (
    <div className="header">
      ...
      badgeContent={ <div className="home__badge"> <CameraAltOutlined className="home__camera"/> </div>} >
     ...
     <Avatar className={classes.large}/>
      ...
      <div className="home__btn">Manage your google account</div> 
              ...
              <div className="home__popover__btm">
                ...
                <Button onClick={() => auth.signOut()} variant="outlined" className="home__signOut">Sign Out</Button>
